import { LightningElement, wire, api, track } from 'lwc';
    ...
    import SLA_FIELD from '@salesforce/schema/Account.ShippingCountry';
    import UPSELL_FIELD from '@salesforce/schema/Account.ShippingState';
    
    export default class ContactPicklistTest extends LightningElement {
