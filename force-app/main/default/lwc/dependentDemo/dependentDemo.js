...
export default class CountryStateCityExample extends LightningElement {
    ...
    countryChange(event) {
        ...
        if (event.target.name == "Country") {
            ...
            for (var stateValue in this.data[0][this.selectedcountry]) {
            ...
            for (var cityValue in this.data[0][this.selectedcountry][event.target.value]) {
                var obj = {};
                obj.label = cityValue;
                obj.value = cityValue;
            ...
            this.selectedCity=this.data[0][this.selectedcountry][this.selectedState][event.target.value];
        }
    }
}